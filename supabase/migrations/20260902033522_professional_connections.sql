...
CREATE INDEX idx_professional_connections_client ON public.professional_connections (client_id);
CREATE INDEX idx_professional_connections_professional ON public.professional_connections (professional_id, status);
